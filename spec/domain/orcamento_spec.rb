...
describe Geo::Core::Orcamento do
  describe "criacao" do
    it "deve criar passando parametros validos" do
      orcamento = Geo::Core::Orcamento.new(cliente: "Cliente", descricao: "descricao")
    ...
    it "nao deve criar passando parametros invalidos" do
      orcamento = Geo::Core::Orcamento.new(cliente: nil, descricao: nil)
